  ...
  return (
    <div className="p-10 w-full max-w-7xl mx-auto">
      ...
      {emails.length === 0 ? (
        ...
        // <div className="w-full overflow-y-auto overflow-x-hidden max-h-[600px]">
        <div className="w-full overflow-y-auto overflow-x-hidden max-h-[600px] border border-gray-200 rounded-2xl bg-white shadow-md">
